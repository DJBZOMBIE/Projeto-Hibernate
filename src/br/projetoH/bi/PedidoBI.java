...
public class PedidoBI {
	...
	public static void createPedidoItem(Pedido ped, ArrayList<Item> itens) throws PedidoException{
	...
	public static void criarPedido(Cliente cliente) throws PedidoException{
		EntityManagerFactory factory = Persistence.createEntityManagerFactory("loja2");
		EntityManager entityManager = factory.createEntityManager();
